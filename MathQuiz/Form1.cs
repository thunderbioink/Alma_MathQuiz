    ...
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (CheckTheAnswer())
            {
                ...
                // got the answer right. Stop the timer and close the form.
                timer1.Stop();
            ...
            else if (timeLeft > 0)
            {
                ...
                // Decrease the time left by one second and display the new 
                // time left by updating the Time Left label.
                timeLeft = timeLeft - 1;
